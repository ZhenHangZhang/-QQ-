...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSLog(@"%@",((DEMOViewController*)self.sideMenuViewController.contentViewController).selectedViewController);
    ...
    [((UINavigationController*)((DEMOViewController*)self.sideMenuViewController.contentViewController).selectedViewController) pushViewController:vc animated:YES];
